...
class Chat(UUIDMixin, TimestampMixin, Base):
    ...
    seeker_session_id: Mapped[str] = mapped_column(String(256), nullable=False, index=True)
    ...
    def __repr__(self) -> str:
        return f"<Chat id={self.id} property_id={self.property_id} status={self.status}>"
