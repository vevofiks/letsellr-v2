...
class Testimonial(UUIDMixin, TimestampMixin, Base):
    ...
    author_role: Mapped[str] = mapped_column(
        String(50), nullable=False, comment="owner, seeker, agency"
    )
    ...
    avatar_key: Mapped[str | None] = mapped_column(
        String(500), nullable=True, comment="R2 object key"
    )
    ...
    is_active: Mapped[bool] = mapped_column(
        Boolean, default=True, nullable=False, comment="False for soft deleted"
    )
