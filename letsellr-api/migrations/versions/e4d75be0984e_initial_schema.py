...
Revision ID: e4d75be0984e
Revises: 
Create Date: 2026-07-15 11:58:14.429740
"""
...
def upgrade() -> None:
    ...
    sa.Column('preference_type', sa.String(length=255), nullable=False, comment="e.g. 'residential'"),
