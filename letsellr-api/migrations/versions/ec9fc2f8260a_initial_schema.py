...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_property_types_id"), "property_types", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_property_types_slug"), "property_types", ["slug"], unique=True
    )
    op.create_table(
        "reviews",
        sa.Column(
    ...
    op.create_index(
        op.f("ix_reviews_target_id"), "reviews", ["target_id"], unique=False
    )
    op.create_table(
        "testimonials",
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(length=20), nullable=False, comment="active | suspended"
        ),
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        op.f("ix_users_auth_provider_uid"), "users", ["auth_provider_uid"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_users_verification_status"),
        "users",
        ["verification_status"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agency_profiles_id"), "agency_profiles", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_agency_profiles_user_id"), "agency_profiles", ["user_id"], unique=True
    )
    op.create_table(
        "properties",
        ...
        sa.Column(
            "intent", sa.String(length=20), nullable=False, comment="rent | buy | lease"
        ),
        sa.Column(
            "enquiry_type",
            sa.String(length=20),
        ...
        sa.Column(
            "review_data", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_properties_category"), "properties", ["category"], unique=False
    )
    op.create_index(op.f("ix_properties_id"), "properties", ["id"], unique=False)
    op.create_index(
        op.f("ix_properties_intent"), "properties", ["intent"], unique=False
    )
    op.create_index(
        op.f("ix_properties_location_city"),
        "properties",
        ["location_city"],
        unique=False,
    )
    op.create_index(
        op.f("ix_properties_owner_id"), "properties", ["owner_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(length=20), nullable=False, comment="open | closed"
        ),
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        op.f("ix_chats_property_id"), "chats", ["property_id"], unique=False
    )
    op.create_index(
        op.f("ix_chats_seeker_session_id"), "chats", ["seeker_session_id"], unique=False
    )
    op.create_table(
        "messages",
        sa.Column("chat_id", sa.UUID(), nullable=False),
        sa.Column(
            "sender", sa.String(length=20), nullable=False, comment="seeker | owner"
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_verification_requests_status"), table_name="verification_requests"
    )
    op.drop_index(
